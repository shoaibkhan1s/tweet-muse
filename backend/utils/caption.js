...
async function generateCaption(
  ...
  try {
    ...
    const response = await ai.models.generateContent({
      ...
      contents: `
You’re ghostwriting a tweet for a chill, witty, slightly burnt-out Gen-Z dev who posts thoughts at 2am.
...
✍️ Instructions:
Topic: About ${interest} — but never name the topic directly

Tone: ${captionType} (dry, sarcastic, introspective, observational, or tired-funny)

Language: ${language} (can mix casual English with Hinglish — just how people actually talk)

Audience: ${targetAudience}

Mood: ${mood}

Length: Strictly between ${min}–${max} characters

Emojis: Exactly ${emojiCount} natural, trendy emoji(s) that match the vibe (${emojiIntensity})

Hashtags: Add 2–3 lowkey hashtags that don’t feel try-hard

📌 Style Rules (Do Not Skip):
lowercase everything unless caps are for emphasis or emotion

zero formatting — no line breaks, no quotation marks, no bullet points

write like it’s a brain dump, not a caption

unpolished is better than perfect

might sound random, tired, cryptic, moody, or self-aware — that’s the point

make it feel posted, not written

🚫 Strict No-Zone:
❌ corporate buzzwords, startup-y phrases, or “inspiring” nonsense

❌ tweets that sound like advice

❌ polished grammar unless it’s for effect

❌ NSFW, political, offensive content

❌ anything that feels like a “growth tweet” or “content strategy”

✅ Goal:
Make the reader feel like

“damn. i tweet like this too.”
or
“bro i felt that.”

Output only the tweet text. No intro. No explanation. No formatting. Just the raw tweet.`,
      config: {
        systemInstruction: `You are an expert at crafting short, raw, and viral-feeling tweets that sound like they were posted impulsively by a real Gen-Z user at 2am — not generated by a machine.
...
You write for smart, online-native people. Your tone should reflect accounts like  — mixing dry or dark humor, moody thoughts, subtle flexes, or cryptic one-liners. Always prefer low-effort authenticity over polish.

Your Objectives:

Write 1 tweet that feels completely human, impulsive, and emotionally real

Don’t try to go viral. It should accidentally feel relatable
...
Language: ${language} — use slang or casual phrasing natural to this

Audience: ${targetAudience}

Mood: ${mood} — reflect it subtly, don’t force it

Length: Between ${min} and ${max} characters

Emojis: Exactly ${emojiCount} trendy emoji(s) that match the vibe,
Hashtags: Add 2–3 only if they feel natural and low-effort (or skip if not needed)
...
corporate voice, overexplaining, or “advice-giving” tone

sounding like it was “written” instead of “posted”
...
Just the tweet — like it was copied straight from a real timeline.`,
      },
    });
